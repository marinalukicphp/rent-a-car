...
<form class="col-6" action="rute.php" method="get">
 ...
 <input type="text" name="imevozaca" class="form-control"  placeholder="Unesite ime vozaca">
 <span style="color:red;"><?php if(array_key_exists('ime',$errors))echo $errors['ime'];?></span>
 <br><br>



 <input type="text" name="prezimevozaca" class="form-control"  placeholder="Unesite prezime vozaca">
 <span style="color:red;"><?php if(array_key_exists('prezime',$errors))echo $errors['prezime'];?></span>
 <br><br>



 <input type="text" name="godistevozaca" class="form-control" placeholder="Unesite godiste vozaca">
 <span style="color:red;"><?php if(array_key_exists('godiste',$errors))echo $errors['godiste'];?></span>
 <br><br>


<input type="submit" name="akcija" class="btn btn-primary" value="Unesite vozaca">
