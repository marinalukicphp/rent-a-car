...
<a href="index.php" class="btn btn-warning">Nazad</a>
 ...
 <?php
  ...
  foreach($prikazvozaca as $voz){

 echo "<tr>";
 echo "<td>$voz[ime]</td>";
 echo "<td>$voz[prezime]</td>";
 echo "<td>$voz[godiste]</td>";
 echo "<td><a class='btn btn-danger'href='rute.php?akcija=obrisivozaca&idvoz=$voz[idvozaca]'>Obrisi</a></td>";
 echo "<td><a class='btn btn-success'href='rute.php?akcija=prikazizmenevozaca&idvozaca=$voz[idvozaca]'>Izmeni</a></td>";
 echo "</tr>";
